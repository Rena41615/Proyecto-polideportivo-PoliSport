...
public class PlanNutricional {
    ...
    @Min(value = 1200, message = "Las calorías diarias deben ser al menos 1200")
    private Integer caloriasDiariasGr;

    @Column(name = "proteina_gr")
    @NotNull(message = "Las proteínas diarias son obligatorias")
    @Min(value = 50, message = "Las proteínas diarias deben ser al menos 50 gramos")
    ...
    @NotNull(message = "Los lípidos diarios son obligatorios")
    @Min(value = 30, message = "Los lípidos diarios deben ser al menos 30 gramos")

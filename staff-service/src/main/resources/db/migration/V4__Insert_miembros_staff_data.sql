...
-- Insertar más datos de miembros de staff

INSERT INTO `miembros_staff` (`nombre`, `apellido`, `documento`, `telefono`, `email`, `fecha_ingreso`, `activo`) VALUES
('Carlos', 'López', '1555666777', '+573301111111', 'carlos.lopez@polisport.com', CURDATE(), true),
('María', 'Sánchez', '1888999000', '+573402222222', 'maria.sanchez@polisport.com', CURDATE(), true),
('Juan', 'Fernández', '1111222333', '+573503333333', 'juan.fernandez@polisport.com', CURDATE(), true),
('Patricia', 'Díaz', '1444555666', '+573604444444', 'patricia.diaz@polisport.com', CURDATE(), true),

package com.polisport.common.mapper.inventario;

import com.polisport.inventario.model.Instalacion;
import com.polisport.common.dto.inventario.*;
...
public class InstalacionMapper {
    ...
    public Instalacion crearDTOToEntity(InstalacionCrearDTO dto) {
        ...
        entity.setNombreInstalacion(dto.getNombreInstalacion());
    ...
    public InstalacionDTO entityToDTO(Instalacion entity) {
        ...
        dto.setNombreInstalacion(entity.getNombreInstalacion());

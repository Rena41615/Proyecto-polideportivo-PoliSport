...
INSERT INTO `permisos` (`id`, `nombre`, `descripcion`) VALUES
                (1, 'EDITAR_USUARIO', 'Permiso para editar información de usuario'),
                ...
                (8, 'VER_BIOMETRIA', 'Permiso para ver datos biométricos'),
                (9, 'EDITAR_BIOMETRIA', 'Permiso para editar datos biométricos'),
                (10, 'GESTIONAR_ROLES', 'Permiso para gestionar roles del sistema'),
                (11, 'VER_AUDITORIA', 'Permiso para ver logs de auditoría'),
